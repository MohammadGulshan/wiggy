...
const AppCards = ( card ) => {
    ...
    }, [state.cards, card.card.cards, card]); // passing an empty array as second argument triggers the callback in useEffect only after the initial render thus replicating `componentDidMount` lifecycle behaviour
