...
const AppCards = ({ card }) => {
    ...
    const [cardeee, setCardeee] = useState(0);

    useEffect(() => {
        setCardeee(cardeee => card.cards); // Here, card is object passed as parameter to main component and cardeee is object inside it. so card.cardeee is assigned to const cardeee of the current component.
        console.log('mount it!', cardeee);
