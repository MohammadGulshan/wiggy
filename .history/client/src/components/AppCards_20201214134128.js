...
const AppCards = ( card ) => {
    ...
    const [state, setState] = useState({
        cards: []
    }); // Here, card is object passed as parameter to main component and cards is object inside it. so card.cards is assigned to const cards of the current component.
    ...
    }, [state.cards, card.card.cards]); // passing an empty array as second argument triggers the callback in useEffect only after the initial render thus replicating `componentDidMount` lifecycle behaviour
