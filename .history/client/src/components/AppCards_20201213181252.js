...
const AppCards = ({ card }) => {
    ...
    const [cards, setCards] = useState(card.cards); // Here, card is object passed as parameter to main component and cards is object inside it. so card.cards is assigned to const cards of the current component.
                                            ...
                                            <CardBody>
                                                <CardTitle tag="h5">
                                                    ...
                                                    <Button color="dark" 
                                                        ...
                                                        size="sm"
                                                        onClick={() => {
                                                            setCards(cards => (cards.filter(v => v.id !== value.id)));
                                                        }}
                                                    >
                                                        X
                                                    </Button>
