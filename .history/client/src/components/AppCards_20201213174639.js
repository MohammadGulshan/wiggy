...
const AppCards = ({ card }) => {
    ...
    useEffect(() => {
        setCardeee(card.cards); // Here, card is object passed as parameter to main component and cardeee is object inside it. so card.cardeee is assigned to const cardeee of the current component.
