...
const AppCards = ({ card }) => {
    ...
    const [cardssss, setCardssss] = useState(card.cards);

    useEffect(() => {
        // setCardssss(card.cards); // Here, card is object passed as parameter to main component and cardssss is object inside it. so card.cardssss is assigned to const cardssss of the current component.
        console.log('mount it!', cardssss);
