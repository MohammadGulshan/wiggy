...
const AppCards = ({ card }) => {
    ...
    useEffect(() => {
        setCards(card.cards); // Here, card is object passed as parameter to main component and cards is object inside it. so card.cards is assigned to const cards of the current component.
